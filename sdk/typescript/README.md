...
The TypeScript SDK wraps the `codex` CLI from `@unieai/code`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @unieai/code-sdk
```
...
```typescript
import { Codex } from "@unieai/code-sdk";
