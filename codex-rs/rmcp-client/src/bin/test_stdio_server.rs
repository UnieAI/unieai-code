...
impl TestToolServer {
    ...
    /// Tool intended for manual testing of UnieAI TUI rendering for MCP image tool results.
    ///
    ...
    ///
    /// Manual testing approach (UnieAI TUI):
    ...
    /// - Then in UnieAI TUI, ask it to call:
...
/// Scenarios for `image_scenario`, intended to exercise UnieAI TUI handling of MCP image outputs.
///
