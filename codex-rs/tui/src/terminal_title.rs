...
//! "leave the old title alone" or "clear the title UnieAI Code last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title UnieAI Code manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before UnieAI Code started managing the title.
