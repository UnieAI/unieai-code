...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for UnieAI Code",
            ...
            SlashCommand::App => "continue this session in UnieAI Code Desktop",
            SlashCommand::Quit | SlashCommand::Exit => "exit UnieAI Code",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how UnieAI Code performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for UnieAI Code",
            ...
            SlashCommand::Permissions => "choose what UnieAI Code is allowed to do",
            ...
            SlashCommand::Logout => "log out of UnieAI Code",
