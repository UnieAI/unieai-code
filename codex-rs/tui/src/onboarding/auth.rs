...
impl KeyboardHandler for AuthModeWidget {
    ...
    fn handle_paste(&mut self, pasted: String) {
        ...
        match &*sign_in_state {
            ...
            SignInState::UnieAIStudioUrlEntry(_) | SignInState::UnieAIGatewayUrlEntry(_) => {
                drop(sign_in_state);
...
impl AuthModeWidget {
    ...
    /// (API key, Bedrock, UnieAI Studio URL, or UnieAI gateway URL).
    pub(crate) fn is_text_entry_active(&self) -> bool {
        self.sign_in_state.read().is_ok_and(|guard| match &*guard {
            ...
            SignInState::UnieAIStudioUrlEntry(_) | SignInState::UnieAIGatewayUrlEntry(_) => true,
            _ => false,
        })
    }
