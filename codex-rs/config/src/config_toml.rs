//! Schema-heavy configuration TOML types used by UnieAI.
...
pub struct ConfigToml {
    ...
    /// sanctioned by UnieAI will likely degrade model performance.
    ...
    /// file: Use a file in the UnieAI home directory.
    ...
    /// Directory where UnieAI writes log files. Setting this value explicitly
    ...
    /// Optional product SKU forwarded on host-owned UnieAI Apps MCP requests.
...
pub struct DebugConfigLockToml {
    ...
    /// Allow replaying a lock generated by a different UnieAI version.
