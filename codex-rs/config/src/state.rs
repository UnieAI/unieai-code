...
impl ConfigLayerEntry {
    ...
    // Get the config folder (`.unieai/`, or legacy `.codex/` for projects) associated with this config layer, if any.
    ...
    /// Returns the config folder (`.unieai/` or legacy `.codex/`) that should be used for hook declarations.
    ///
