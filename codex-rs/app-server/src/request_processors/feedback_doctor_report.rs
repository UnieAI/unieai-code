...
//! the configured UnieAI executable as a subprocess, accepts only valid JSON from
...
///
/// Failure to spawn UnieAI, finish before the timeout, or parse JSON means the
