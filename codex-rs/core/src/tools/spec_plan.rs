...
fn add_core_tool_sources(context: &CoreToolPlanContext<'_>, registry: &mut ToolRegistry) {
    ...
    add_session_mesh_tools(context, registry);
}
...
fn add_session_mesh_tools(context: &CoreToolPlanContext<'_>, registry: &mut ToolRegistry) {
    ...
    if features.enabled(Feature::SessionMesh) && features.enabled(Feature::SessionMeshTasks) {
        ...
        registry.add(crate::tools::handlers::session_mesh::ListTasksHandler);
        registry.add(crate::tools::handlers::session_mesh::SpawnPeerSessionHandler);
    }
}
