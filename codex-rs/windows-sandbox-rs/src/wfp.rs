...
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for UnieAI Windows sandbox filters";
const SUBLAYER_NAME: &str = "Codex Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for UnieAI Windows sandbox filters";
...
/// Installs the persistent UnieAI WFP filters for `account`.
///
...
/// Ensures the persistent UnieAI WFP provider exists.
...
/// Ensures the persistent UnieAI sublayer exists under the UnieAI provider.
