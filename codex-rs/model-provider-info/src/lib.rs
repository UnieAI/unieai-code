//! Registry of model providers supported by UnieAI.
//!
//! Providers can be defined in two places:
//!   1. Built-in defaults compiled into the binary so UnieAI works out-of-the-box.
...
pub fn built_in_model_providers(
    ...
    // providers are bundled with UnieAI CLI, so we only include the OpenAI and
