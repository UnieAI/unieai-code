...
#[derive(Debug, Parser)]
#[command(bin_name = "unieai plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces UnieAI is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "unieai plugin marketplace add",
    after_help = "Examples:\n  unieai plugin marketplace add ./path/to/marketplace\n  unieai plugin marketplace add owner/repo --ref main\n  unieai plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "unieai plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "unieai plugin marketplace upgrade",
    after_help = "Examples:\n  unieai plugin marketplace upgrade\n  unieai plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "unieai plugin marketplace remove",
    after_help = "Example:\n  unieai plugin marketplace remove debug"
)]
