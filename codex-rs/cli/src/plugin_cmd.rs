...
#[derive(Debug, Parser)]
#[command(bin_name = "unieai plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "unieai plugin add",
    after_help = "Examples:\n  unieai plugin add sample@debug\n  unieai plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "unieai plugin list",
    after_help = "Examples:\n  unieai plugin list\n  unieai plugin list --marketplace debug\n  unieai plugin list --json\n  unieai plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "unieai plugin remove",
    after_help = "Examples:\n  unieai plugin remove sample@debug\n  unieai plugin remove sample --marketplace debug"
)]
