...
/// The easiest way to iterate is to add unit tests and have UnieAI fix the implementation.
...
/// Tests are at the top to encourage using TDD + UnieAI to fix the implementation.
mod tests {
    use super::*;
