//! Trace bundle format, writer, and reducer for UnieAI rollouts.
//!
//! This crate owns the trace schema. Hot-path UnieAI code should depend on the
...
/// Shared recorder context for inference attempts within one UnieAI turn.
...
/// Request data for the canonical UnieAI tool boundary.
...
/// Append-only writer used by hot-path UnieAI instrumentation.
