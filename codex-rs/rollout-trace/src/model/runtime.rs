...
/// Runtime operation requested by the model, a JS code cell, or UnieAI itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the UnieAI tool boundary.
    ///
    ...
    /// they describe how UnieAI executed the request, not what the caller sent.
