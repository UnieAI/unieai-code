...
/// One UnieAI thread/session participating in the rollout.
///
...
/// Provenance for a traced UnieAI thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the UnieAI runtime for one thread.
///
/// A UnieAI turn groups protocol/runtime work for one thread activation.
