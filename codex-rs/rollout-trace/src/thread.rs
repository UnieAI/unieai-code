...
impl ThreadTraceContext {
    ...
    ///
    /// Trace startup is best-effort. A tracing failure must not make the UnieAI
    ...
    /// Emits typed UnieAI turn lifecycle events from protocol lifecycle events.
    ...
    /// what UnieAI did while executing that boundary.
    ...
    /// Builds reusable inference trace context for one UnieAI turn.
    ///
