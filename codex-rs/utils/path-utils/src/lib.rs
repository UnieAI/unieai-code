//! Path normalization, replacement, symlink resolution, and atomic writes shared across UnieAI crates.
...
/// Compare paths after applying UnieAI's filesystem normalization.
///
