...
const PLATFORM_PACKAGE_BY_TARGET = {
  "x86_64-unknown-linux-musl": "@unieai/code-linux-x64",
  "aarch64-unknown-linux-musl": "@unieai/code-linux-arm64",
  "x86_64-apple-darwin": "@unieai/code-darwin-x64",
  "aarch64-apple-darwin": "@unieai/code-darwin-arm64",
  "x86_64-pc-windows-msvc": "@unieai/code-win32-x64",
  "aarch64-pc-windows-msvc": "@unieai/code-win32-arm64",
};
...
function findCodexExecutable() {
  ...
  const updateCommand =
    packageManager === "bun"
      ? "bun install -g @unieai/code@latest"
      : packageManager === "pnpm"
        ? "pnpm add -g @unieai/code@latest"
        : packageManager === "vite-plus"
          ? "vp install -g @unieai/code@latest"
...
function isPnpmOwnedCodexInstall(nodeModulesDir) {
  ...
  try {
    return (
      realpathSync(path.join(nodeModulesDir, "@unieai", "code")) ===
      codexPackageRoot
    );
  } catch {
    return false;
