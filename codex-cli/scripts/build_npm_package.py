#!/usr/bin/env python3
"""Stage and optionally package the @unieai/code npm module."""
...
# The underlying package published to npm is always `@unieai/code`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@unieai/code-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@unieai/code-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@unieai/code-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@unieai/code-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@unieai/code-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@unieai/code-win32-arm64",
        "npm_tag": "win32-arm64",
