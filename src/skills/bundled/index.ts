...
export function initBundledSkills(): void {
  ...
  // Vendored skill packs (generated by scripts/generate-bundled-vendored-skills.mjs)
  require('./vendored/taste.generated.js').registerTasteSkills()
  require('./vendored/finance.generated.js').registerFinanceSkills()
  require('./vendored/browser-harness.generated.js').registerBrowserHarnessSkills()
