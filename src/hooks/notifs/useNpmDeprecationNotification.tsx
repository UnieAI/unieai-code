...
// UnieAI Code: upstream's "Claude Code switched to native installer" nudge
// doesn't apply to us — UnieAI Code ships as @unieai/code on npm. Disabled.
// Restore by reverting the unconditional `return null` below.
...
async function _temp() {
  ...
  return null as unknown as { timeoutMs: number; key: string; text: string; color: string; priority: string };
}
