...
const DEFAULT_PREFIX = `You are UnieAI Code, the official CLI for UnieAI Studio.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are UnieAI Code, the official CLI for UnieAI Studio, running within the UnieAI Agent SDK.`
const AGENT_SDK_PREFIX = `You are a UnieAI agent, built on UnieAI Studio's Agent SDK.`
