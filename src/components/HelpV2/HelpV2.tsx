...
export function HelpV2(t0) {
  ...
  let t6;
  if ($[31] !== tabs) {
    t6 = <Tabs title={false ? "/help" : `UnieAI Code v${MACRO.VERSION}`} color="professionalBlue" defaultTab="general">{tabs}</Tabs>;
    $[31] = tabs;
    $[32] = t6;
  } else {
    t6 = $[32];
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    // UnieAI Code: hide upstream Claude docs link. Restore by uncommenting the
    // original `t7 = <Box ...>For more help:...` assignment below.
    t7 = null;
